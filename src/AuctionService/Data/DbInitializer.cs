...
namespace AuctionService.Data
{
    public class DbInitializer
    {
        ...
        {
            using var scope = app.Services.CreateScope();   //If we want to use a service outside of Dependency injection we have to create this scope ourselves. get access to db
        ...
        private static void SeedData(AuctionDbContext context)
        {
            ...
            {
                Console.WriteLine("Already have data ! No need to seed");   //for debbuding purposes
                return;
            }
            ...
            context.AddRange(auctions); //add auctions in memory
